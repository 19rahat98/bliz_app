    ...
    Widget _gruzList(List<Data> listCategoryItems) {
      ...
      return ListView.builder(
        ...
        itemBuilder: (_, int index) => InkWell(
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>Application(gruzInfo: listCategoryItems[index],)));
          },
          child: Container(
                ...
                Row(
                  ...
                  children: [
                    Container(
                        ...
                        child: RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text: listCategoryItems[index].details.first.from != null ? '${listCategoryItems[index].details.first.from}' : 'error',
                                style: TextStyle(
                                    fontSize: 17.0,
                              ...
                              TextSpan(
                                text: listCategoryItems[index].details.first.to != null ? '${listCategoryItems[index].details.first.to}' : 'error',
                                style: TextStyle(
                                    fontSize: 17.0,
                                    fontWeight: FontWeight.w500,
                                    color: Colors.black),
                    ...
                    Column(
                      children: [
                        Text(
                          listCategoryItems[index].price.first.price != null ? '${listCategoryItems[index].price.first.price}' : 'error',
                          style: TextStyle(
